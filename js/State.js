...
function StateMachine() {
    ...
    this.GetState = function (name) {
        if (this.states[name] != null) {
            ...
            console.error("StateMachine::getState - this is not a state called [ " + name + " ]");
        }
    }
    ...
    this.SetState = function (state) {
        if (state != null) {
            if (state == this.currentState) {
                console.warning("WARNING @ StateMachine::setCurrentState -" + "var state [ " + state.name + " ] is the same as current state" );
                return;
            }
            ...
            console.error( "ERROR @ StateMachine::setCurrentState - " + " var [state] is not a class type of State" );
        }
    }
}
